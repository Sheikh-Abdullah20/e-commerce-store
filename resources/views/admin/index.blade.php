...
<html lang="en">
    <head>
        ...
        <link href="assets2/css/main.css?v=6.0" rel="stylesheet" type="text/css" />
    </head>
    ...
    <body>
        ...
        <aside class="navbar-aside" id="offcanvas_aside">
            <div class="aside-top">
                <a href="index.html" class="brand-wrap">
                    <img src="assets2/imgs/theme/logo.svg" class="logo" alt="Nest Dashboard" />
                </a>
                <div>
            ...
            <nav>
                <ul class="menu-aside">
                    ...
                    <li class="menu-item has-submenu">
                        ...
                        <div class="submenu">
                            <a href="page-sellers-cards.html">Cat 1 </a>
                            <a href="page-sellers-list.html">Cat 2</a>
                            <a href="page-seller-detail.html">Cat 3</a>
                        </div>
                    </li>
                    <li class="menu-item">
                    ...
                    <ul class="nav">
                        ...
                        <li class="dropdown nav-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-start" aria-labelledby="dropdownLanguage">
                                <a class="dropdown-item text-brand" href="#"><img src="assets2/imgs/theme/flag-us.png" alt="English" />English</a>
                                <a class="dropdown-item" href="#"><img src="assets2/imgs/theme/flag-fr.png" alt="Français" />Français</a>
                                <a class="dropdown-item" href="#"><img src="assets2/imgs/theme/flag-jp.png" alt="Français" />日本語</a>
                                <a class="dropdown-item" href="#"><img src="assets2/imgs/theme/flag-cn.png" alt="Français" />中国人</a>
                            </div>
                        </li>
                        <li class="dropdown nav-item">
                            <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#" id="dropdownAccount" aria-expanded="false"> <img class="img-xs rounded-circle" src="assets2/imgs/people/avatar-2.png" alt="User" /></a>
                                        ...
                                        <div class="new-member-list">
                                            <div class="d-flex align-items-center justify-content-between mb-4">
                                                <div class="d-flex align-items-center">
                                                    <img src="assets2/imgs/people/avatar-4.png" alt="" class="avatar" />
                                                    <div>
                                                        <h6>Patric Adams</h6>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-4">
                                                <div class="d-flex align-items-center">
                                                    <img src="assets2/imgs/people/avatar-2.png" alt="" class="avatar" />
                                                    <div>
                                                        <h6>Dilan Specter</h6>
                                                        <p class="text-muted font-xs">Sanfrancisco</p>
                                                    </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-4">
                                                <div class="d-flex align-items-center">
                                                    <img src="assets2/imgs/people/avatar-3.png" alt="" class="avatar" />
                                                    <div>
                                                        <h6>Tomas Baker</h6>
                                                        <p class="text-muted font-xs">Sanfrancisco</p>
                                                    </div>
        ...
        <!-- Main Script -->
        <script src="assets2/js/main.js?v=6.0" type="text/javascript"></script>
