...
<head>
    <meta charset="utf-8" />
    <title>Category - {{ $products_In_Category[0]->category_name}}</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <h3 class="title-detail"><span class="text-heading"></span></h3>
            ...
            <div class="container">
                <div class="archive-header">
                    <div class="row align-items-center">
                        <div class="col-xl-3">
                            <h1 class="mb-15">{{ $products_In_Category[0]->category_name }}</h1>
                            <div class="breadcrumb">
                                <a href="{{ route('home') }}" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
                                <span></span> Shop <span></span> {{ $products_In_Category[0]->category_name }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="shop-product-fillter">
                        <div class="totall-product">
                            ...
                            <p>We found <strong class="text-brand"> {{ $products_In_Category->first()->products->count() }} </strong> items for you!</p>
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href=" {{ route('product.cart',$product)  }}">
                                            <img class="default-img" src="{{ asset('storage/' . $product->product_image) }}" alt="" />
                                ...
                                <div class="product-content-wrap">
                                    <div class="product-category">
                                        <a href="{{ route('product.cart',$product) }}">{{ $product->product_name }}</a>
                                    </div>
                                    <h2><a href="{{ route('product.cart',$product) }}">{{ $product->product_description }}</a></h2>
                                    ...
                                    <div class="product-card-bottom">
                                        ...
                                        <div class="add-cart">
                                            <a class="add" href="{{ route('product.cart',$product) }}"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
