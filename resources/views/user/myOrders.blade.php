                ...
                <div class="col-12">
                    <div class="shop-product-fillter">
                        <div class="totall-product">
                            ...
                            <p>We found Your <strong class="text-brand">{{ $orders->count() }}</strong> Orders  in Our Mart..!</p>
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        ...
                                        <img class="default-img" src="{{asset('storage/' . $order->product->product_image)}}" alt="" />
                                            
                                    </div>
                                    <div class="product-badges product-badges-position product-badges-mrg">
                                        @if($order->status === 'Active')
                                        <span class="hot bg-success">{{$order->status}}</span>
                                        @elseif($order->status === 'Pending')
                                        <span class="hot bg-warning">{{$order->status}}</span>
                                        @elseif($order->status === 'Delivered')
                                        <span class="hot bg-info text-dark">{{$order->status}}</span>
                                        @endif
                                    </div>
                                </div>
