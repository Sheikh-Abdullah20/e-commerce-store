        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="{{ route('category.products',$product->category->id) }}">{{ $product->category->category_name }}</a> <span></span> {{ $product->product_name }}
                </div>
            </div>
        </div>
                                        ...
                                        <div class="product-cart-wrap hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="{{ route('product.cart',$product) }}" tabindex="0">
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="{{ route('product.cart',$product) }}" tabindex="0">{{ $product->product_name }}</a></h2>
